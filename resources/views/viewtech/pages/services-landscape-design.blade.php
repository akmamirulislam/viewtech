                ...
                <div class="row">
                    <div class="col-md-12">                    
                        <div class="page-title-heading">
                            <h1 class="title">Landscape Design</h1>
                ...
                <div class="row">
                    <div class="col-md-9 col-md-push-3">
                        <div class="services-main-text">
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="../assets/viewtech/images/services/5-1.jpg" alt="images">
                                    <div class="flat-divider d30px"></div>
                                    <img src="../assets/viewtech/images/services/5-2.jpg" alt="images">
                                </div><!-- /.col-md-6 -->
